...
配套 npm 包 [`vite-plugin-agent-eyes`](https://www.npmjs.com/package/vite-plugin-agent-eyes)（源码与完整文档：[webkubor/vite-plugin-agent-eyes](https://github.com/webkubor/vite-plugin-agent-eyes)）。
